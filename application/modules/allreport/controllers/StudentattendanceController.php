...
class Allreport_StudentattendanceController extends Zend_Controller_Action {
	...
	public function rptStudentMistakeAction()
	{
		...
		$this->view->student = $group->getDailyStudentMistake($search);
		$this->view->search = $search;
	...
	public function rptTotalStudentMistakeAction()
	{
		if ($this->getRequest()->isPost()) {
			$search = $this->getRequest()->getPost();
			$group = new Allreport_Model_DbTable_DbAttendanceReport();
			$this->view->student = $group->getReportStudentMistake($search);
			$this->view->search = $search;
	...
	public function rptPreAttendanceAction(){
		...
		$this->view->search = $search;
		$db = new Allreport_Model_DbTable_DbAttendanceReport();
		$this->view->absenteeRs = $db->getStudentPreAttendanceReport($search);
		
		$form = new Application_Form_FrmCombineSearchGlobal();
		$forms = $form->FormPreAttendance();
		Application_Model_Decorator::removeAllDecorator($forms);
		$this->view->form_search = $form;
	...
	public function rptReqPermissionAction(){
		if ($this->getRequest()->isPost()) {
			$search = $this->getRequest()->getPost();
		} else {
			$search = array(
		...
		$search["forReport"] = 1;
		$group = new Allreport_Model_DbTable_DbAttendanceReport();
		$result = $group->getStudentRequestPermission($search);
		
		$this->view->rs = empty($result["result"]) ? [] : $result["result"];
		$this->view->search = $search;
		
		$form=new Application_Form_FrmCombineSearchGlobal();
		$form->FormSearchReqpermission();
	...
	public function rptAttendenceSubjAction()
	{
		if ($this->getRequest()->isPost()) {
			$search = $this->getRequest()->getPost();
		} else {
		...
		$this->view->search = $search;
		$db = new Allreport_Model_DbTable_DbAttendanceReport();
		$this->view->student = $db->getStudentAttendenceWithScheule($search);//
		$this->view->schOfGroup = $db->getAttGroupSchedule($search);//
	...
	public function rptStutelegrambotAction()
	{
		if ($this->getRequest()->isPost()) {
			$search = $this->getRequest()->getPost();
		} else {
		...
		$this->view->search = $search;
		$db = new Allreport_Model_DbTable_DbAttendanceReport();
		$this->view->rs = $db->getStuConnectedTelegramBot($search);

		$form=new Application_Form_FrmCombineSearchGlobal();
		$form->FormSearchStuConnectedTelegram();
		Application_Model_Decorator::removeAllDecorator($form);
		$this->view->form_search = $form;
	...
	public function rptTelegraminfoAction(){
		...
		$this->view->search = $search;
		$db = new Allreport_Model_DbTable_DbAttendanceReport();
		$this->view->absenteeRs = $db->getTelegramInfoReport($search);
		
		$form = new Application_Form_FrmCombineSearchGlobal();
		$forms = $form->FormTelegramInfo();
		Application_Model_Decorator::removeAllDecorator($forms);
		$this->view->form_search = $form;
