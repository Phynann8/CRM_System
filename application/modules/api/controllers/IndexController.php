...
//     	header('Content-Type: application/json');
    	...
    	if ($_SERVER['REQUEST_METHOD'] == "GET"){
			...
			}else if ($GetData['url']=="achievementDetail"){
    			$_dbAction->getAchievementDetailAction($GetData);
			...
			}else if ($GetData['url']=="stPmtValidationInfo"){
    			$_dbAction->getStPmtValidationInfoAction($GetData);
    		}
    		else{
    		...
    		if($this->getRequest()->isPost()){
				...
				}else if ($GetData['url']=="changePasswordBus"){// change password
					$_dbAction->changePasswordBusAction($postData);
				}else if ($GetData['url']=="updateTokenStatus"){
					$_dbAction->updateTokenStatusAction($postData);
   ...
   function uploaddataAction(){
		...
		if($this->getRequest()->isPost()){
			...
			if (isset($_FILES['file'])) {
				$uploadDir = PUBLIC_PATH . '/images/document/tmp/';
