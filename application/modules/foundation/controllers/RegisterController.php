	...
	public function indexAction(){
		try{
			if($this->getRequest()->isPost()){
				...
				$actionLink = [
						["title" =>"edit","recordConnect" =>"id" ,"link" => "/foundation/register/edit"],
						["title" =>"copy","recordConnect" =>"id" ,"link" => "/foundation/register/copy"],
						["title" =>"view","recordConnect" =>"id" ,"link" => "/foundation/register/view"],
						["title" =>"editFamily","recordConnect" =>"familyId" ,"link" => "/foundation/family/edit"]
					];
				$rowRecordInfo = [
					"groupId" => 0,
					"familyId" => 0,
