...
class Global_DegreeController extends Zend_Controller_Action {
    ...
    public function indexAction()
    {
    	...
    	$collumns = array("FACULTY_KHNAME","FACULTY_ENNAME","SHORTCUT","COURSE_TYPE","ORDERING","SCHOOL_OPTION","BY_USER","CREATE_DATE","MODIFY_DATE","STATUS");
    	$link=array(
    ...
    function refreshitemsAction(){
    	if($this->getRequest()->isPost()){
    		...
    		$d_row = $_dbgb->getAllItems($type,null,null,0,'','',null,null,$data);
