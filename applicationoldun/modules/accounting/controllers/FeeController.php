...
class Accounting_FeeController extends Zend_Controller_Action {
    ...
    public function indexAction()
    {
    	try{
    		...
    		$collumns = array("BRANCH","ACADEMIC_YEAR","TYPE_STUDY","IS_MULTY_STUDY","TYPE","SCHOOL_OPTION","CREATE_DATE","PROCESS_TYPE","BY_USER","STATUS");
    		$link=array(
    ...
    public function addAction()
    {
		...
		$this->view->paymentTermList =  $model->getPaytermTypeList();
    }
	...
	function copyAction(){
		...
		if(empty($row)){
			...
			$rowsTerm = $model->getAllPaymentTerm(null,$hidemonth=1);
			$this->view->term_option =	$rowsTerm ;
			$this->view->paymentTermList =  $model->getPaytermTypeList();
