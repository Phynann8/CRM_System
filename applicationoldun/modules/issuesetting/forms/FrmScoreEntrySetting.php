...
class Issuesetting_Form_FrmScoreEntrySetting extends Zend_Dojo_Form
{
	...
	function FrmAddScoreEntrySetting($data)
	{
		...
		$forTerm = new Zend_Dojo_Form_Element_FilteringSelect("forTerm");
		$forTerm->setMultiOptions($_arr);
		$forTerm->setAttribs(array(
				'dojoType'=>'dijit.form.FilteringSelect',
				'required'=>'false',
				'placeholder'=>$this->tr->translate("SELECT_SEMESTER"),
				'missingMessage'=>'Invalid Module!',
				'class'=>'fullside height-text',));
		$forTerm->setValue($request->getParam("forTerm"));
