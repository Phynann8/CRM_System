...
class Registrar_Form_FrmSearchInfor extends Zend_Dojo_Form {
	...
	public function FrmSearchRegister($type=1){ 
		...
		$_recordOrdering->setAttribs(array('dojoType'=>$this->filter,
		...
		$_recordOrdering->setValue($request->getParam("recordOrdering"));
