		...
		try{
		  $db = new Setting_Model_DbTable_DbCertificate();
		   if($this->getRequest()->isPost()){
			  ...
			  $collumns = array("BRANCH","TYPE","TITLE","DEGREE","SCHOOL_OPTION","ISSUE_DATE","STATUS");
			  $link=array(
							'module'=>'setting','controller'=>'certificate','action'=>'edit',
			  );
			  $this->view->list=$list->getCheckList(0, $collumns, $rs_rows,array('title'=>$link,'branch_name'=>$link,'type'=>$link));
		  }catch (Exception $e){
