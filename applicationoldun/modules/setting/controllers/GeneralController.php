...
public function init()
	...
	public function indexAction()
	{
		...
		$row['telegramBotName'] = $db_gs->geLabelByKeyName('telegramBotName');
		$row['telegramBotToken'] = $db_gs->geLabelByKeyName('telegramBotToken');
		
		$row['receiptDescTitle'] = $db_gs->geLabelByKeyName('receiptDescTitle');
		$row['receiptDesc'] = $db_gs->geLabelByKeyName('receiptDesc');
		$row['scoreSystemStatus'] = $db_gs->geLabelByKeyName('scoreSystemStatus');
		$row['disableChAvg'] = $db_gs->geLabelByKeyName('disableChAvg');
		...
		$this->view->row = $row;
		$this->view->rsBranch = $db_gs->getAllBranchForSetting();
