...
// 				'readonly'=>true
	...
	public function FrmCertificate($data=null){
		...
		$name_eng_left=new Zend_Dojo_Form_Element_NumberTextBox('name_eng_left');
		$name_eng_left->setAttribs(array(
				'dojoType'=>'dijit.form.NumberTextBox',
				'class'=>'fullside',
				'required'=>true,
		));
		$name_eng_top=new Zend_Dojo_Form_Element_NumberTextBox('name_eng_top');
		$name_eng_top->setAttribs(array(
				'dojoType'=>'dijit.form.NumberTextBox',
				'class'=>'fullside',
				'required'=>true,
		));
		...
		$gender_eng_left = new Zend_Dojo_Form_Element_NumberTextBox('gender_eng_left');
		$gender_eng_left->setAttribs(array(
			'dojoType'=>'dijit.form.NumberTextBox',
			'class'=>'fullside',
			'required'=>true,
		));
		$gender_eng_top = new Zend_Dojo_Form_Element_NumberTextBox('gender_eng_top');
		$gender_eng_top->setAttribs(array(
			'dojoType'=>'dijit.form.NumberTextBox',
			'class'=>'fullside',
			'required'=>true,
		));
		...
		$date_eng_left = new Zend_Dojo_Form_Element_NumberTextBox('date_eng_left');
		$date_eng_left->setAttribs(array(
				'dojoType'=>'dijit.form.NumberTextBox',
				'class'=>'fullside',
				'required'=>true,
		));

		$date_eng_top = new Zend_Dojo_Form_Element_NumberTextBox('date_eng_top');
		$date_eng_top->setAttribs(array(
				'dojoType'=>'dijit.form.NumberTextBox',
				'class'=>'fullside',
				'required'=>true,
		));
		...
		$grade_eng_left = new Zend_Dojo_Form_Element_NumberTextBox('grade_eng_left');
		$grade_eng_left->setAttribs(array(
			'dojoType'=>'dijit.form.NumberTextBox',
				'class'=>'fullside',
				'required'=>true,
		));
		$grade_eng_top = new Zend_Dojo_Form_Element_NumberTextBox('grade_eng_top');
		$grade_eng_top->setAttribs(array(
			'dojoType'=>'dijit.form.NumberTextBox',
				'class'=>'fullside',
				'required'=>true,
		));

		$duration_left = new Zend_Dojo_Form_Element_NumberTextBox('duration_left');
		$duration_left->setAttribs(array(
			'dojoType'=>'dijit.form.NumberTextBox',
				'class'=>'fullside',
				'required'=>true,
		));
		$duration_top = new Zend_Dojo_Form_Element_NumberTextBox('duration_top');
		$duration_top->setAttribs(array(
			'dojoType'=>'dijit.form.NumberTextBox',
				'class'=>'fullside',
				'required'=>true,
		));

		$duration_eng_left = new Zend_Dojo_Form_Element_NumberTextBox('duration_eng_left');
		$duration_eng_left->setAttribs(array(
			'dojoType'=>'dijit.form.NumberTextBox',
				'class'=>'fullside',
				'required'=>true,
		));
		$duration_eng_top = new Zend_Dojo_Form_Element_NumberTextBox('duration_eng_top');
		$duration_eng_top->setAttribs(array(
			'dojoType'=>'dijit.form.NumberTextBox',
				'class'=>'fullside',
				'required'=>true,
		));
		$issue_date_left = new Zend_Dojo_Form_Element_NumberTextBox('issue_date_left');
		$issue_date_left->setAttribs(array(
			'dojoType'=>'dijit.form.NumberTextBox',
				'class'=>'fullside',
				'required'=>true,
		));
		$issue_date_top = new Zend_Dojo_Form_Element_NumberTextBox('issue_date_top');
		$issue_date_top->setAttribs(array(
			'dojoType'=>'dijit.form.NumberTextBox',
				'class'=>'fullside',
				'required'=>true,
		));
		...
		$type->setAttribs(array('dojoType'=>$this->filter,"class"=>"fullside",));
		$_type_opt = array(
			''=>$this->tr->translate("SELECT_TYPE"),
			1=>$this->tr->translate("HORNOR_CERTIFICATE"),
			2=>$this->tr->translate("OUTSTANDING_STUDENT"),
			3=>$this->tr->translate("STUDENT_ACHIEVEMENT"),
			4=>$this->tr->translate("CERTIFICATE"),
		);
		$type->setMultiOptions($_type_opt);
		$type->setValue($request->getParam("type"));

		$issue_date = new Zend_Dojo_Form_Element_DateTextBox('issue_date');
		$now = date("Y-m-d");
		$issue_date->setAttribs(
			array(
				'data-dojo-Type'=>"dijit.form.DateTextBox",
				'constraints'=>"{datePattern:'dd/MM/yyyy'}",
				'class'=>'fullside',
		...
		if(!empty($data)){
			...
			$name_eng_left->setValue($data['name_eng_left']);
			$name_eng_top->setValue($data['name_eng_top']);
			$gender_eng_left->setValue($data['gender_eng_left']);
			$gender_eng_top->setValue($data['gender_eng_top']);
			$grade_eng_left->setValue($data['grade_eng_left']);
			$grade_eng_top->setValue($data['grade_eng_top']);
			$date_eng_left->setValue($data['date_eng_left']);
			$date_eng_top->setValue($data['date_eng_top']);
			$duration_left->setValue($data['duration_left']);
			$duration_top->setValue($data['duration_top']);
			$duration_eng_left->setValue($data['duration_eng_left']);
			$duration_eng_top->setValue($data['duration_eng_top']);
			$issue_date_left->setValue($data['issue_date_left']);
			$issue_date_top->setValue($data['issue_date_top']);
