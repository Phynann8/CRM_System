...
class Stock_ProductController extends Zend_Controller_Action {
	...
	public function indexAction()
    {
    	try{
	    	...
	    	$collumns = array("CODE","PRODUCT_NAME","PRODUCT_CATEGORY","STOCK_TYPE","TYPE","ONE_PAYMENT","MODIFY_DATE","BY_USER","STATUS","ACTIVE");
	    	$link=array(
    ...
    public function addAction(){
		...
		$this->view->grade = $db->getAllGradeList();
    }
    ...
    public function editAction(){
		...
		$this->view->grade = $model->getAllGradeList();
    }
